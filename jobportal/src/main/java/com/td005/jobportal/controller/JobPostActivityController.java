...
import com.td005.jobportal.services.JobSeekerApplyService;
...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model ,
                             ...
                             @RequestParam(value = "fullTime",required = false) boolean today,
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if(authentication.getAuthorities().contains(new SimpleGrantedAuthority("recruiter"))){
                ...
                for(JobPostActivity jobPostActivity:jobPost)
                {
                    ...
                    {
                        if(Objects.equals(jobPostActivity.getJobPostId(),jobSeekerApply1.getJob().getJobPostId())){
