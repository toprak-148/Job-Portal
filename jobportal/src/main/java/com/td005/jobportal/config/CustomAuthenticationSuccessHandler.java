...
//basarili bir sekilde oturum acildiginda kullanici nesnesinin alıp rolleri kontrol etmek icin olustrulurdu.
...
public class CustomAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request,
        ...
        System.out.println("The username " + username + " is logged.");
